...
import com.example.androidweek5.databinding.ActivitySignUpBinding
...
class SignUp : AppCompatActivity() {
    ...
    private fun onSubmit(){
        if(viewModel.errEmail.value == "" && viewModel.errName.value == "" && viewModel.errPassword.value == "") {
            ...
            Toast.makeText(this,"${viewModel.errPassword.value} , ${viewModel.errEmail.value}, ${viewModel.errName.value}",
